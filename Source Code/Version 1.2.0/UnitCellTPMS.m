classdef UnitCellTPMS < handle
    ...
    methods
		...
		function calcJCALParam(unitCell)
			...
			unitCell.viscous_length = sqrt((8*unitCell.alpha_inf*eta)./ ...
				(unitCell.sigma*unitCell.phi*unitCell.CellArch.M_viscous));
			
			unitCell.k0_prime = 1/8*unitCell.phi.*unitCell.thermal_length.^2 * ...
				unitCell.CellArch.M_thermal;
		end
