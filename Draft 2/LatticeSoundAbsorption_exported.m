classdef LatticeSoundAbsorption_exported < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        CurrentLayerNode % Current Lattice Layer to change
    end
    ...
    methods (Access = private)
        ...
        function showLayer(app,layer)
            if nargin == 2
                app.UnitCellDropDown.Value = layer.UnitCell.CellArch.Name;
                app.CellSizemmSlider.Value = layer.UnitCell.cell_length;
                app.RelativeDensitySlider.Value = layer.UnitCell.rel_density;
    ...
    methods (Access = private)
        ...
        function startupFcn(app)
            ...
            app.UnitCellLibrary = cellArchLib;
        ...
        function CrossSectionDropDownValueChanged(app, event)
            ...
            % Lattice Layers
            app.LatticeStructure.changeParam(NewCrossSection, ...
        ...
        function LengthDiametermmSliderValueChanged(app, event)
            ...
            % Lattice Layers.
            app.LatticeStructure.changeParam(app.CrossSectionDropDown.Value, ...
                value,value);
        ...
        function NumberofDistinctLayersSpinnerValueChanged(app, event)
            ...
            if app.LatticeStructure.num_layers < value
                ...
                app.CurrentLayerNode = app.LatticeStructure.Tail;
        ...
        function FrequencySpinnerValueChanging(app, event)
            ...
            app.Frequency = app.FrequencySpinner.Value:10:app.FrequencySpinner_2.Value;
            app.LatticeStructure.changeFreq(app.Frequency);
            app.SAC = app.LatticeStructure.SAC;
        end
        ...
        function UnitCellDropDownValueChanged(app, event)
            app.CurrentLayerNode = app.LatticeStructure.getNode(app.CurrentLayerNum);
            app.CurrentLayer = app.CurrentLayerNode.Data;
            app.CurrentLayer.changeUC(app.UnitCellDropDown.Value);
        end
        ...
        function CellSizemmSliderValueChanged(app, event)
            app.CurrentLayerNode = app.LatticeStructure.getNode(app.CurrentLayerNum);
            app.CurrentLayer = app.CurrentLayerNode.Data;
            app.CurrentLayer.UnitCell.setLcell(app.CellSizemmSlider.Value);
        ...
        function RelativeDensitySliderValueChanged(app, event)
            app.CurrentLayerNode = app.LatticeStructure.getNode(app.CurrentLayerNum);
            app.CurrentLayer = app.CurrentLayerNode.Data;
            app.CurrentLayer.UnitCell.setRD(app.RelativeDensitySlider.Value);
        end
        ...
        function NumberofLayersSpinnerValueChanged(app, event)
            app.CurrentLayerNode = app.LatticeStructure.getNode(app.CurrentLayerNum);
            app.CurrentLayer = app.CurrentLayerNode.Data;
            app.CurrentLayer.setNz(app.NumberofLayersSpinner.Value);
            app.updateThickness(); % Update Thickness
        end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.LayerPanel.Position = [705 -38 310 200];
